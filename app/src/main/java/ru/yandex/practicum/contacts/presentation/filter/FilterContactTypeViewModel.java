...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        String[] filtersList = ContactType.getContactTypes();

        ArrayList<FilterContactTypeUi> filtersListUi = new ArrayList<>();
        filtersListUi.add(createAllSelectedItem(filtersList));

        for (String filter : filtersList)
            filtersListUi.add(createFilterContactType(filter));

        filterContactTypesLiveDate.setValue(filtersListUi);
